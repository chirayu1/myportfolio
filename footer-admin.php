...
<body>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
				    ...
				    <a href="footer-admin.php" class="list-group-item list-group-item-action active">Footer</a>
				</div>
			</div>
			<div class="col-md-9">
				...
				<form>
			    	<div class="form-group">
				  		<br>
			      		<textarea class="form-control" rows="5" id="footer_title" name="footer_title" placeholder="Enter Footer"><?php echo $row['title']; ?></textarea>
			    	</div>
	...
	<footer>
		<div class="container text-center">
        	...
        	<!-- Use PHP date function for year -->
      </div>
	</footer>
