		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
				    ...
				    <a href="about-admin.php" class="list-group-item list-group-item-action active">About</a>
			...
			<div class="col-md-9">
				...
				<form>
			    	<div class="form-group">
				  		<br>
			      		<textarea class="form-control" rows="7" id="about" name="about" placeholder="Enter details for the about section.."><?php echo $row['about']; ?></textarea>
			    	</div>
